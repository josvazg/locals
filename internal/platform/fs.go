...
func (osf *osFilesystem) WriteFile(filename string, data []byte, perm fs.FileMode) error {
	return os.WriteFile(filename, data, perm)
}

func (osf *osFilesystem) ReadDir(dirname string) ([]fs.DirEntry, error) {
	return os.ReadDir(dirname)
}

func (osf *osFilesystem) CreateDir(dir string) error {
	return osf.MkdirAll(dir, 0750)
}

func (osf *osFilesystem) MkdirAll(dirname string, perm fs.FileMode) error {
	return os.MkdirAll(dirname, perm)
}

func (osf *osFilesystem) PathExists(filename string) bool {
	_, err := os.Stat(filename)
	return err == nil
}

func (osf *osFilesystem) Stat(filename string) (os.FileInfo, error) {
	return os.Stat(filename)
}

func (osf *osFilesystem) RemoveFiles(filenames ...string) error {
...
func (osf *osFilesystem) removeFile(filename string) error {
...
func (osf *osFilesystem) ListFiles(globs ...string) ([]string, error) {
	paths := []string{}
